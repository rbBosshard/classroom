            ...
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-lg text-gray-600">
                        Sicherer als Caesar - aber trotzdem knackbar!
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
            ...
            <div class="prose prose-lg max-w-none">
                <p class="text-gray-700 leading-relaxed mb-4">
                    ...
                    des Alphabets ein <strong>zufälliger anderer Buchstabe</strong> zugeordnet - nicht nur eine
                    einfache Verschiebung wie bei Caesar.
                </p>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input v-model="inputText" type="text" placeholder="Gib einen Text ein..."
                ...
                <div class="bg-purple-50 rounded-lg p-4 border border-purple-200">
                    <p class="text-sm font-semibold text-purple-900 mb-2">📋 Aktuelles Substitutions-Alphabet:</p>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-orange-50 border-l-4 border-orange-500 p-5 rounded">
                    ...
                    <ol class="space-y-3 text-orange-800">
                        ...
                        <li class="flex items-start">
                            ...
                            <span>Der häufigste Buchstabe ist <strong>E</strong> (17% im
                                Deutschen)</span>
                        </li>
                        <li class="flex items-start">
                ...
                <div class="bg-blue-50 rounded-lg p-5">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm">
                        <div class="bg-white p-2 rounded">E: ~17%</div>
                        <div class="bg-white p-2 rounded">N: ~10%</div>
                        <div class="bg-white p-2 rounded">I: ~8%</div>
                        <div class="bg-white p-2 rounded">S: ~7%</div>
                        <div class="bg-white p-2 rounded">R: ~7%</div>
                        <div class="bg-white p-2 rounded">A: ~7%</div>
                        <div class="bg-white p-2 rounded">T: ~6%</div>
                        <div class="bg-white p-2 rounded">D: ~5%</div>
                        <div class="bg-white p-2 rounded">H: ~5%</div>
                    </div>
                    <p class="text-sm text-blue-700 mt-3">
                        💡 Diese Häufigkeiten bleiben auch bei Substitution erhalten, einfach für andere Buchstaben!
                    </p>
                </div>
            </div>
        </div>
...
const displayKey = computed(() => {
    ...
    return ALPHABET.split('').map((char, i) =>
        `${char}→${substitutionKey.value[i]}`
    ).join(' ');
});
