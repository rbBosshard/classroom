  ...
  <div class="crypto-card p-4 sm:p-6 md:p-8">
    ...
    <div class="mb-6 sm:mb-8">
      <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-3 sm:mb-4">
        📜 Die Skytale – Das wohl älteste Verschlüsselungsverfahren der Welt
      </h2>
      <div class="bg-purple-50 border-l-4 border-purple-400 p-4 mb-4 sm:mb-6 rounded-r">
        <p class="text-gray-700 mb-2">
          Die <strong>Skytale</strong> (griechisch: σκυτάλη, <em>skytálē</em> = «Stab») ist ein
          <strong>Transpositionsverfahren</strong>, das bereits vor über
          <strong>2500 Jahren</strong> von den Spartanern im alten Griechenland verwendet wurde, um
          geheime militärische Botschaften zu übermitteln.
        </p>
        <p class="text-gray-600 text-sm mt-2">
          <strong>Prinzip:</strong> Die Buchstaben werden nicht ersetzt, sondern nur in ihrer
          Reihenfolge vertauscht (transponiert).
        </p>
      </div>
    </div>
    ...
    <div
      class="mb-8 bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg border-2 border-amber-300"
    >
      <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center gap-2">
        ⚔️ So verschlüsselt ein Spartaner seine Botschaft
      </h3>
      <div class="bg-white p-4 rounded-lg mb-4 border border-amber-200">
        <p class="text-gray-700 italic mb-3">
          «Ich bin ein Bote aus Sparta. Wenn unser Heer im Krieg ist, müssen wir manchmal geheime
          Nachrichten an weit entfernte Truppen schicken: Befehle, Warnungen, Anweisungen.»
        </p>
      </div>
      ...
      <div class="space-y-3">
        <div class="flex gap-3">
          <div
            class="flex-shrink-0 w-8 h-8 bg-amber-500 text-white rounded-full flex items-center justify-center font-bold"
          >
            1
          </div>
          <p class="text-gray-700 pt-1">
            Ich nehme einen <strong>Holzstab (Skytale)</strong> mit einem bestimmten Durchmesser.
          </p>
        </div>
        <div class="flex gap-3">
          <div
          ...
          <p class="text-gray-700 pt-1">
            Danach wickle ich <strong>spiralförmig einen langen Lederstreifen</strong> um den
            Holzstab.
          </p>
        </div>
        <div class="flex gap-3">
          ...
          <p class="text-gray-700 pt-1">
            Auf diesen gewickelten Streifen schreibe ich <strong>längs meine Nachricht</strong>,
            Zeile für Zeile entlang des Stabes, zum Beispiel:
            <code class="bg-amber-100 px-2 py-1 rounded font-bold">THIS IS SPARTA</code>
          </p>
        </div>
        ...
        <div class="flex gap-3">
          ...
          <p class="text-gray-700 pt-1">
            Wenn ich fertig bin, <strong>wickle ich den Lederstreifen wieder ab</strong>. Jetzt
            stehen die Buchstaben kreuz und quer, völlig unlesbar oder!?
          </p>
        </div>

        <!-- Bild: Skytale Geheimtext -->
        <div class="flex justify-center my-4">
          <img
        ...
        <div class="flex gap-3">
          ...
          <p class="text-gray-700 pt-1">
            Nur jemand, der einen <strong>Stab mit dem gleichen Durchmesser</strong> hat, kann den
            Streifen richtig aufwickeln und damit die wahre Nachricht lesen.
          </p>
        </div>
      </div>
      ...
      <div class="mt-4 bg-amber-100 p-4 rounded-lg border border-amber-300">
        <p class="text-sm font-medium text-amber-900">
          ❓ <strong>Check:</strong> Was ist bei Skytale der geheime Schlüssel?
        </p>
        <details class="mt-2">
          <summary class="cursor-pointer text-sm text-amber-800 hover:text-amber-900 font-medium">
            Lösung anzeigen
          </summary>
    ...
    <!-- Interactive Skytale -->
    <div class="mb-8">
      <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4">🎯 Interaktive Skytale</h3>
      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="bg-white p-4 rounded-lg border-2 border-gray-200">
          <label class="block text-sm font-medium text-gray-700 mb-2">
            📝 Klartext (wird ohne Leerzeichen verschlüsselt):
          </label>
          <textarea
            v-model="plaintext"
            ...
            rows="3"
          ></textarea>
          <p class="text-sm text-gray-500 mt-1">Länge: {{ plaintextClean.length }} Zeichen</p>
        </div>

        <!-- Visualization Grid -->
        <div
          class="bg-gradient-to-br from-purple-50 to-indigo-50 p-6 rounded-lg border-2 border-purple-200"
        >
            ...
            <div class="inline-block min-w-full">
              ...
              >
                ...
                <div
                  ...
                  :class="[
                    char
                      ? 'bg-white border-2 border-purple-400 text-purple-800'
          ...
          <div class="bg-white p-3 rounded-lg border border-purple-200 mb-4">
            <p class="text-sm text-gray-700">
              <strong>Verschlüsselung:</strong> Lies die Buchstaben
              <span class="text-purple-600 font-bold">spaltenweise von oben nach unten</span>,
              Spalte für Spalte.
            </p>
            <p class="text-sm text-gray-600 mt-1">
              <strong>Entschlüsselung:</strong> Schreibe die Buchstaben wieder spaltenweise in das
              Gitter und lies dann <span class="text-purple-600 font-bold">zeilenweise</span>.
            </p>
          </div>
    ...
    <!-- Entschlüsselung Section -->
    <div
      class="mb-8 bg-gradient-to-r from-blue-50 to-cyan-50 p-6 rounded-lg border-2 border-blue-200"
    >
      <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4">🔓 Entschlüsselung</h3>

      <div class="space-y-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2"> Geheimtext eingeben: </label>
          <textarea
            ...
            rows="3"
          ></textarea>
          <p class="text-sm text-gray-500 mt-1">Länge: {{ decryptInput.length }} Zeichen</p>
        </div>
    ...
    <div class="space-y-6">
      ...
      <div class="bg-gray-50 p-6 rounded-lg border-2 border-gray-200">
        <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4">🧮 Wie funktioniert's?</h3>
        <div class="space-y-3 text-gray-700">
          ...
          <ol class="list-decimal list-inside space-y-2 ml-4">
            <li>
              Text wird zeilenweise in ein Gitter mit
              <code class="bg-white px-2 py-1 rounded">n</code> Spalten geschrieben
            </li>
...
N I S</pre
            >
            <p class="mt-2">
              Geheimtext (spaltenweise):
              <span class="text-purple-600 font-bold">DIIHNISNEIETGISSEMES</span>
            </p>
          </div>

          <p class="mt-4">
            <strong>Entschlüsselung:</strong>
          </p>
          <ol class="list-decimal list-inside space-y-2 ml-4">
            <li>
              Berechne Anzahl Zeilen:
              <code class="bg-white px-2 py-1 rounded">Zeilen = ⌈Textlänge / Spalten⌉</code>
            </li>
      ...
      <div class="bg-amber-50 p-6 rounded-lg border-2 border-amber-200">
        <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4">
          🛡️ Wie sicher ist die Skytale?
        </h3>
        <div class="space-y-3 text-gray-700">
          <p><strong>Nicht sehr sicher!</strong> Die Skytale hat folgende Schwächen:</p>
          <ul class="list-disc list-inside space-y-2 ml-4">
            <li>
              <strong>Kleiner Schlüsselraum:</strong> Nur die Anzahl der Spalten ist geheim (meist
              2-10)
            </li>
            <li>
              <strong>Brute-Force:</strong> Alle Möglichkeiten können schnell ausprobiert werden
            </li>
            <li><strong>Statistik:</strong> Buchstabenhäufigkeit bleibt erhalten</li>
          </ul>
          <p class="mt-3 text-amber-800 font-medium">
            ⚠️ Die Skytale war für ihre Zeit (ca. 500 v. Chr.) eine clevere Lösung, ist aber heute
      ...
      <!-- Toblerone-Aufgabe -->
      <div
        class="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-lg border-2 border-yellow-300"
      >
        <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4 flex items-center gap-2">
          🍫 Toblerone-Aufgabe
        </h3>
        <div class="bg-white p-4 rounded-lg mb-4 border border-yellow-200">
          <p class="text-gray-700 mb-3">
            <strong>Aufgabe:</strong> Wickle einen Lederstreifen gedanklich um eine
            <strong>Toblerone</strong> anstatt um einen Holzstab.
          </p>
          <p class="text-gray-700 mb-2">
            Übermittle folgende Nachricht:
            <code class="bg-yellow-100 px-2 py-1 rounded font-bold text-lg">DIE PERSER KOMMEN</code>
          </p>
          <p class="text-sm text-gray-600">
            <em
              >Hinweis: Entferne dabei wie im Beispiel auch zuerst die Leerzeichen. Benutze das
              Raster, um das Aufwickeln des Lederbandes um die Toblerone zu simulieren.</em
            >
          </p>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg border-2 border-yellow-300">
          <div
            class="mb-4 bg-blue-50 p-3 rounded-lg border border-blue-200 flex items-center gap-4"
          >
            ...
            <div class="flex-1">
              <p class="text-sm font-medium text-blue-900">
                ℹ️ Eine Toblerone hat <strong>3 Seiten</strong> (dreieckige Form). Fülle das 3×5
                Raster aus, indem du die Nachricht <strong>zeilenweise</strong> einträgst!
              </p>
            </div>
          </div>
          ...
          <div class="mb-4">
            <p class="text-sm font-medium text-gray-700 mb-2">
              ...
              <code class="bg-yellow-100 px-2 py-1 rounded">DIEPERSERKOMMEN</code>
            </p>
          </div>
          ...
          <div class="overflow-x-auto mb-4">
            ...
            >
              <input
                ...
                :class="[
                  tobleroneValidation[index] === null
                    ? 'bg-white border-gray-400 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200'
                    : tobleroneValidation[index] === true
          ...
          <div v-if="tobleroneIsComplete" class="mb-4">
            <div
              v-if="tobleroneIsCorrect"
              class="bg-green-100 border-2 border-green-500 p-4 rounded-lg"
            >
          ...
          <div
            v-if="tobleroneIsCorrect"
            class="bg-green-50 p-4 rounded-lg border-2 border-green-300"
          >
            <p class="text-sm font-medium text-gray-700 mb-2">
          ...
          <details class="mt-4">
            <summary
              class="cursor-pointer text-sm text-yellow-800 hover:text-yellow-900 font-medium"
            >
              💡 Hilfe anzeigen
            </summary>
            <div class="mt-3 p-4 bg-yellow-100 rounded-lg border border-yellow-300">
              ...
              <ul class="text-sm text-gray-700 list-disc list-inside space-y-1">
                <li>
                  Schreibe die Nachricht <strong>DIEPERSERKOMMEN</strong> Buchstabe für Buchstabe
                </li>
                <li>
                  Beginne <strong>links oben</strong> und gehe <strong>zeilenweise</strong> vor
                </li>
              </ul>
            </div>
          </details>
        ...
        <div class="mt-4 bg-orange-100 p-4 rounded-lg border border-orange-300">
          <p class="text-sm font-medium text-orange-900 mb-2">
            🤔 <strong>Denkfrage:</strong> Wie könnte ein Feind den Geheimtext knacken (ohne den
            Schlüssel zu kennen)?
          </p>
          <details class="mt-2">
            <summary
              class="cursor-pointer text-sm text-orange-800 hover:text-orange-900 font-medium"
            >
              Antwort anzeigen
            </summary>
            <div class="mt-2 text-sm text-orange-900 space-y-2">
              ...
              <p class="mt-2 font-medium">
                ➜ Deshalb ist die Skytale gegen moderne Angriffe nicht sicher!
              </p>
            </div>
          </details>
        </div>
      ...
      <div class="bg-indigo-50 p-6 rounded-lg border-2 border-indigo-200">
        <h3 class="text-lg sm:text-xl font-semibold text-gray-700 mb-4">
          📚 Übungen (entferne jeweils die Leerzeichen)
        </h3>
        <div class="space-y-4">
          <!-- Übung 1 -->
          <div
            class="bg-white p-4 rounded-lg border-2 transition-all duration-300"
            :class="exercise1Status === 'correct' ? 'border-green-400' : 'border-gray-200'"
          >
            <p class="font-medium text-gray-800 mb-3">1. Verschlüssle "HALLOWELT" mit 3 Spalten</p>
            <div class="flex flex-wrap gap-3 items-end">
              <div class="flex-1 min-w-[200px]">
                ...
                <input
                  ...
                  :class="
                    exercise1Status === 'correct'
                      ? 'border-green-500 bg-green-50'
                      : exercise1Status === 'incorrect'
            ...
            <!-- Feedback -->
            <div
              v-if="exercise1Status === 'correct'"
              class="mt-3 p-3 bg-green-100 border border-green-400 rounded-lg flex items-center gap-2"
            >
              <span class="text-xl">✅</span>
              <span class="text-green-800 font-medium"
                >Richtig! Der Geheimtext ist "HLEAOLLWT"</span
              >
            </div>
            <div
              v-else-if="exercise1Status === 'incorrect'"
              class="mt-3 p-3 bg-red-100 border border-red-400 rounded-lg flex items-center gap-2"
            >
              <span class="text-xl">❌</span>
              <span class="text-red-800 font-medium"
                >Noch nicht ganz. Tipp: Schreibe "HALLOWELT" in 3 Spalten und lies
                spaltenweise!</span
              >
            </div>
            ...
            <details class="mt-3 text-sm text-gray-600">
              <summary class="cursor-pointer hover:text-indigo-600 font-medium">
                💡 Hilfe anzeigen
              </summary>
...
E L T</pre
                ...
                <p class="mt-2 text-xs">
                  Lies spaltenweise: HLE (Spalte 1), AOL (Spalte 2), LWT (Spalte 3)
                </p>
              </div>
            </details>
          </div>
          ...
          <div
            class="bg-white p-4 rounded-lg border-2 transition-all duration-300"
            :class="exercise2Status === 'correct' ? 'border-green-400' : 'border-gray-200'"
          >
            <p class="font-medium text-gray-800 mb-3">
              2. Entschlüssle "WASASTESENTRLNNGDEKIU" mit 4 Spalten
            </p>
            <div class="flex flex-wrap gap-3 items-end">
              <div class="flex-1 min-w-[200px]">
                <label class="block text-sm text-gray-600 mb-1">Deine Antwort:</label>
                <input
                  ...
                  class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent uppercase font-mono"
                  :class="
                    exercise2Status === 'correct'
                      ? 'border-green-500 bg-green-50'
                      : exercise2Status === 'incorrect'
                        ? 'border-red-400 bg-red-50'
                        : 'border-gray-300'
                  "
            ...
            <!-- Feedback -->
            <div
              v-if="exercise2Status === 'correct'"
              class="mt-3 p-3 bg-green-100 border border-green-400 rounded-lg flex items-center gap-2"
            >
              <span class="text-xl">✅</span>
              <span class="text-green-800 font-medium"
                >Richtig! Der Klartext ist "WER DAS LESEN KANN IST GUT"</span
              >
            </div>
            <div
              v-else-if="exercise2Status === 'incorrect'"
              class="mt-3 p-3 bg-red-100 border border-red-400 rounded-lg flex items-center gap-2"
            >
              <span class="text-xl">❌</span>
              <span class="text-red-800 font-medium"
                >Noch nicht ganz. Tipp: Schreibe den Geheimtext spaltenweise ins Gitter und lies
                zeilenweise!</span
              >
            </div>
            ...
            <details class="mt-3 text-sm text-gray-600">
              ...
              <div class="mt-2 p-3 bg-indigo-50 rounded">
                <p class="text-xs mb-2">Länge: 21 Zeichen, 4 Spalten → 5 Zeilen</p>
                <p class="text-xs mb-2">
                  Schreibe spaltenweise: WASAST (Spalte 1), ESENT (Spalte 2), RLNNG (Spalte 3),
                  DEKIU (Spalte 4)
                </p>
          ...
          <div
            class="bg-white p-4 rounded-lg border-2 transition-all duration-300"
            :class="exercise3Status === 'correct' ? 'border-green-400' : 'border-gray-200'"
          >
            <p class="font-medium text-gray-800 mb-3">
              3. Knacke "VVVEIINDCIII" (Tipp: 4 oder 5 Spalten)
            </p>
            <div class="flex flex-wrap gap-3 items-end">
              <div class="flex-1 min-w-[200px]">
                <label class="block text-sm text-gray-600 mb-1">Deine Antwort:</label>
                <input
                  ...
                  class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent uppercase font-mono"
                  :class="
                    exercise3Status === 'correct'
                      ? 'border-green-500 bg-green-50'
                      : exercise3Status === 'incorrect'
                        ? 'border-red-400 bg-red-50'
                        : 'border-gray-300'
                  "
            ...
            <!-- Feedback -->
            <div
              v-if="exercise3Status === 'correct'"
              class="mt-3 p-3 bg-green-100 border border-green-400 rounded-lg flex items-center gap-2"
            >
              <span class="text-xl">✅</span>
              <span class="text-green-800 font-medium"
                >Perfekt! Der Klartext ist "VENI VIDI VICI" (mit 4 Spalten)</span
              >
            </div>
            <div
              v-else-if="exercise3Status === 'incorrect'"
              class="mt-3 p-3 bg-red-100 border border-red-400 rounded-lg flex items-center gap-2"
            >
              <span class="text-xl">❌</span>
              <span class="text-red-800 font-medium"
                >Noch nicht ganz. Tipp: Probiere es mit 4 Spalten!</span
              >
            </div>
            ...
            <details class="mt-3 text-sm text-gray-600">
              ...
              <div class="mt-2 p-3 bg-indigo-50 rounded">
                <p class="text-xs mb-2">Mit 4 Spalten (16 Zeichen → 4 Zeilen):</p>
    ...
    <!-- Sources -->
    <Sources :sources="SKYTALE_SOURCES" />
  </div>
</template>
...
function checkExercise1() {
  ...
  const correctAnswer = 'HLEAOLLWT'; // HALLOWELT mit 3 Spalten verschlüsselt
  exercise1Status.value =
    userAnswer === correctAnswer ? 'correct' : userAnswer ? 'incorrect' : null;
}

function checkExercise2() {
  const userAnswer = exercise2Answer.value.toUpperCase().replace(/\s+/g, '');
  const correctAnswer = 'WERDASLESENKANNISTGUT'; //  mit 4 Spalten entschlüsselt
  exercise2Status.value =
    userAnswer === correctAnswer ? 'correct' : userAnswer ? 'incorrect' : null;
}

function checkExercise3() {
  const userAnswer = exercise3Answer.value.toUpperCase().replace(/\s+/g, '');
  const correctAnswer = 'VENIVIDIVICI'; // VVVEIINDCIII mit 4 Spalten entschlüsselt
  exercise3Status.value =
    userAnswer === correctAnswer ? 'correct' : userAnswer ? 'incorrect' : null;
}
