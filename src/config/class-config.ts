...
import { curriculumTree_NEUFELD_29F_GYM1 } from "../types/curriculum-neufeld_29f_gym1";
...
export const classes: Record<ClassId, ClassConfig> = {
  ...
  NEUFELD_29F_GYM1: {
    ...
    year: 29,
    class: "f",
    displayName: "Neufeld 29f GYM1",
    curriculum: curriculumTree_NEUFELD_29F_GYM1,
    description: "",
    color: "green",
  },
};
